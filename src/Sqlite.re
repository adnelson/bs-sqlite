module Statement = {
  ...
  [@bs.send] [@bs.splice]
  external all: (t, array('a)) => Js.Array.t(Js.Json.t) = "";

  [@bs.send] external all_named: (t, 'a) => Js.Json.t = "all";

  [@bs.send] [@bs.splice] external get: (t, array('a)) => Js.Json.t = "";
...
module Connection = {
  ...
  [@bs.get] external memory: t => bool = "";

  [@bs.get] external readonly: t => bool = "";
};
